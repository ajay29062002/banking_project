...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">BANK OF MADURAI </a>
...
<body style="background-image : url(../assets/img/bg_image_1.jpg)">
<?php
    include 'config.php';
...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #FF6700;">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
         ...
         <footer class="text-center mt-5 py-2">
            <p style="color:white;">&copy 2021 <b>AJAY SENTHIL</b> <br>Chairman, Bank of Madurai</p>
        </footer>
